...
export const PopularContent = ({ data }: PopularContentProps) => {
  ...
  return (
    <Card
      className="w-full max-h-[340px] rounded-md bg-white shadow-lg border-none flex flex-col items-center justify-center relative py-6 pt-24 md:pt-36
    "
    >
      ...
      >
        <ShoppingCart className="w-4 h4" />
      </Button>
      {/* add to wishlist */}
      <Button
      title={isLiked ? "Added to Wishlist" : "Add to Wishlist"}
