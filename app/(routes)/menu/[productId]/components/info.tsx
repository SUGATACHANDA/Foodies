  ...
  return (
    <div>
      ...
      <div className="mt-3 flex items-end justify-between">
        <p className="text-base text-left text-neutral-500">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Id quibusdam
          voluptates, explicabo ratione atque error iste? Fuga doloribus esse
          dolorum deserunt quisquam quod id pariatur accusantium? Eius suscipit
          sint sit nihil sapiente blanditiis, nesciunt quos iure distinctio
          pariatur quod quas?
        </p>
      </div>
      ...
      <Button onClick={() => addToCart(product)} className="my-6 w-full py-6 text-xl font-semibold hover:bg-hero hover:text-white flex items-center justify-center gap-3"><ShoppingCartIcon className="w-4 h-4" />Add to Cart</Button>
    </div>
  );
};
