  ...
  return (
    <>
      <Container className="px-4 md:px-12">
        <section className="grid grid-cols-1 md:grid-cols-2 py-5 pt-16">
          <div className="flex flex-col items-start justify-start gap-4">
            ...
            <h2 className="text-5xl font-bold tracking-wider uppercase text-neutral-700 my-4">
              Just Come To <span className="block py-4">Foodies & Order </span>
            </h2>

            <p className="text-base text-center md:text-left text-neutral-500 my-2">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum
              maxime facere recusandae natus voluptatem dignissimos odio ipsam
              consectetur aliquid hic ullam.
            </p>
          ...
          <div>
            <div className="w-full relative h-[450px] flex items-center justify-center">
              <Image
                src="/img/Food.png"
                alt="Food Image"
        ...
        {/* popular section */}
        {/* <section className="grid grid-cols-1 md:grid-cols-4 gap-6 gap-y-20 md:gap-12 my-4 py-12 items-center justify-center">
          {products?.slice(0, 4).map((item) => (
            <PopularContent key={item.id} data={item} />
          ))}
        </section> */}
        <h2 className="text-5xl items-center justify-center md:text-3xl font-bold tracking-wider uppercase text-neutral-700">
            New Arrivals
          </h2>
        <section className="flex items-center justify-center gap-6 gap-y-20 md:gap-12 my-12 py-12">
          {products?.slice(0, 4).map((item) => (
            <PopularContent key={item.id} data={item} />
          ))}
        </section>
        ...
        <section className="my-4 py-12 flex flex-col items-center justify-center">
          ...
          <p className="w-full text-center md:w-[560px] text-base text-neutral-500 my-2">
            ...
            facere recusandae natus voluptatem dignissimos odio ipsam
            consectetur aliquid hic ullam.
          </p>
